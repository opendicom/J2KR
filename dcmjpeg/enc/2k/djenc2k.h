...
#import "djcodece.h" /* for class DJCodecEncoder */


#pragma mark Encoder class for JPEG 2K Lossy

class DCMTK_DCMJPEG_EXPORT DJEncoder2K : public DJCodecEncoder
{
public: 
...
class DCMTK_DCMJPEG_EXPORT DJEncoder2KLossLess : public DJCodecEncoder
{
public: 

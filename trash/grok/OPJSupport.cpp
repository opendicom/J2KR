/*
 ...
 Adapted by Jacques Fauquex to the use of grok (openjepg 2.2) on december 2016
*/
...
where is also found for instance...
                           ...
                           long *compressedDataSize)
{
    ...
    switch (parameters.cod_format)
    {
        case J2K_CFMT:                      /* JPEG-2000 codestream */
            codec_format = OPJ_CODEC_J2K;
            fprintf(stdout,"D: OPJ_CODEC_J2K\r\n");
            break;
            
        case JP2_CFMT:                      /* JPEG 2000 compressed image data */
            codec_format = OPJ_CODEC_JP2;
            fprintf(stdout,"D: OPJ_CODEC_JP2\r\n");
            break;
            
        case JPT_CFMT:                      /* JPEG 2000, JPIP */
            codec_format = OPJ_CODEC_JPT;
            fprintf(stdout,"D: OPJ_CODEC_JPT\r\n");
            break;
    ...
    //GROK
    l_stream = opj_stream_create_buffer_stream(bufferInfo.buf, bufferInfo.len, OPJ_STREAM_WRITE);
    //printf("%p\n",bufferInfo.buf);
    //printf("%lu\n",bufferInfo.len);
    ...
    if (fails) fprintf(stdout,"D: fails\r\n");
    else
    {
        fprintf(stdout,"D: did not fail\r\n");
        printf("%p\n",bufferInfo.buf);
        printf("%lu\n",bufferInfo.len);
